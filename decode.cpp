...
void error_usage() {
  ...
  fprintf(stderr, "  -p <int> (optional) line number to decode, default: -1 for all lines\n");
  fprintf(stderr, "  -i <string> (optional) input tokens file, default: data/output_tokens.txt\n");
  fprintf(stderr, "  -z <string> (optional) optional path to custom tokenizer, default: tokenizer.bin\n");
  exit(EXIT_FAILURE);
}
